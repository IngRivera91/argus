<head>
        ...
        <!-- daterange picker -->
        <link rel="stylesheet" href="adminlte3/daterangepicker/daterangepicker.css">
        <!-- iCheck for checkboxes and radio inputs -->
        <link rel="stylesheet" href="adminlte3/icheck-bootstrap/icheck-bootstrap.min.css">
        <!-- Bootstrap Color Picker -->
        <link rel="stylesheet" href="adminlte3/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
        <!-- Tempusdominus Bbootstrap 4 -->
        <link rel="stylesheet" href="adminlte3/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
        <!-- Select2 -->
        ...
        <link rel="stylesheet" href="adminlte3/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
